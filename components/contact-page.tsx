...
export function ContactPage({ onNavigateToHome }: ContactPageProps) {
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12 animate-fade-in">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Need help with EduTimely? We're here to support your educational journey. Reach out to us for any
              questions, technical support, or feedback.
            </p>
          </div>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">support@edutimely.com</p>
                    </div>
                  </div>
